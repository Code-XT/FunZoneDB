...
import { MovieSearch, MovTopRated } from "../util/requests";
...
const Movies = () => {
  ...
  const search = async () => {
    setIsLoading(true);
    try {
      const data = await MovieSearch(searchTerm, "movie");
      setData(data);
    } catch (error) {
      setIsError(true);
    }
    ...
    <div className="mt-4">
      ...
      {searchTerm === "" ? (
        <div className="container mx-auto mt-8">
          <h2 className="text-3xl font-semibold mb-6">Top Rated Movies</h2>
        </div>
      ) : (
        <div className="container mx-auto mt-8">
